...
# Run from repo root: bash scripts/check-templates-core-paths.sh
set -euo pipefail
...
OBSOLETE_SCRIPTS_IMAGES='templates/core/(scripts|images)/'
OBSOLETE_LEGACY_DIRS='templates/core/workflows/|templates/run-worktree/'
