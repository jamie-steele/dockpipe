...
// RepoRoot returns the layout root for bundled assets: materialized bundle has bundle/core,
// bundle/workflows, lib/, and version; authoring checkouts use src/core/ or templates/ + templates/core/ instead.
