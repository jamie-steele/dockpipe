...
Minimal **resolver-shaped** workflow: one **`kind: host`** step that runs a bundled agnostic script via the **`core.*`** namespace (`scripts/core.assets.scripts.example-resolver-notice.sh`).
