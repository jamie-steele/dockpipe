...
Merged into user projects by **`dockpipe init`**. Policy: **[docs/packages/templates-core-assets.md](../../../docs/packages/templates-core-assets.md)**. **Compose** is optional example assets only — not a runtime or resolver.
