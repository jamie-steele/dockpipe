...
Install this into **stock VS Code** for development, or pack as **`.vsix`** and install into your **Pipeon Code OSS fork** (see **`src/apps/pipeon/docs/pipeon-vscode-fork.md`**).
