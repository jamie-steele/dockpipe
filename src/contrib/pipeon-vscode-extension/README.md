...
Install this into **stock VS Code** for development, or pack as **`.vsix`** and install into your **Pipeon Code OSS fork** (see **`src/pipeon/docs/pipeon-vscode-fork.md`**).
...
| **Pipeon: Open fork & extension docs** | Opens **`src/pipeon/docs/pipeon-vscode-fork.md`** when the workspace is this repository. |
