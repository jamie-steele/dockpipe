...
const TOP_LEVEL_KEY_DETAILS = {
  ...
  capability: "Advanced package/discovery hint. Most workflows should set resolver directly instead.",
  ...
  default_resolver: "Advanced fallback resolver when a step does not set one.",
  default_runtime: "Advanced fallback runtime when a step does not set one.",
  strategy: "Lifecycle wrapper that runs around the workflow.",
  strategies: "Available strategies for selection or validation.",
  runtimes: "Advanced allowlist of runtimes permitted for the workflow.",
...
const STEP_KEY_DETAILS = {
  ...
  cmd: "Shell command line inside the container for this step.",
  ...
  capability: "Optional per-step capability hint when resolver is inferred from package metadata.",
