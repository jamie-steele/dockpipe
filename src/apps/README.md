...
**Pipeon IDE** (editor-side integration) lives under **[src/contrib/pipeon-vscode-extension/](../../src/contrib/pipeon-vscode-extension/)**; docs and shell harness live under **[../pipeon/](../pipeon/)** — different runtime (Node/VS Code) than this tree.
