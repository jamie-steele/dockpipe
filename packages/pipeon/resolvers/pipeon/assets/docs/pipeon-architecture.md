...
This **dockpipe** repository ships **contracts** (artifacts under **`.dockpipe/`** / **`.dorkpipe/`**), a **shell harness** (`src/bin/pipeon`), and a **VS Code extension** stub under **`packages/pipeon/resolvers/pipeon/vscode-extension/`** that you install into your fork or stock VS Code.
