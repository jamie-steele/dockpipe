...
| **`bin/.dockpipe/paste-this-prompt.txt`** | **Single block to paste into an AI assistant** — also **printed to stdout** at end of `run-self-analysis.sh`; generated by **`dorkpipe handoff build-cursor`** |
