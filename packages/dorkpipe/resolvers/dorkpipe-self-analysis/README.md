...
| Output | Purpose |
|--------|---------|
| `dockpipe scope --package dorkpipe handoff/orchestrator-cursor-prompt.md` | Full handoff (sections 1–9), generated by **`dorkpipe handoff build-cursor`** |
| **`dockpipe scope --package dorkpipe handoff/paste-this-prompt.txt`** | **Single block to paste into an AI assistant** — also **printed to stdout** at the end of the self-analysis host entrypoint; generated by **`dorkpipe handoff build-cursor`** |
