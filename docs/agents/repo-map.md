...
| `docs/agents/todo-index.yaml` | AI entrypoint for the indexed cross-cutting backlog; update it and the linked topic files when work materially completes or advances one of its items. |
