...
```bash
dockpipe --workflow codex-security --resolver codex --runtime docker --
```
...
Ships in the dockpipe repo under **`workflows/agent/codex-security/`**; copy the tree or use **`dockpipe init`** with **`--from`** pointing at it. See **[AGENTS.md](../../../AGENTS.md)**.
