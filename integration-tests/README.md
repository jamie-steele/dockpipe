...
bash integration-tests/test_action_resolution.sh
# ... etc
```
...
| `test_action_resolution.sh` | Run from a different cwd with `--action actions/commit-worktree.sh`; asserts relative path resolves to bundled action and commit works. |
