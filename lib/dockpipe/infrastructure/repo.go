...
// RepoRoot returns the layout root for bundled assets: materialized bundle has dockpipe/core,
// dockpipe/workflows, lib/, and version; authoring checkouts use templates/ and templates/core/ instead.
