...
- **config.yml** — run, isolate, act point to repo **scripts/**; optional **vars:** for workflow defaults (merged with `templates/llm-worktree/.env`, repo `.env`, `--env-file`, `$DOCKPIPE_ENV_FILE`, `--var`). See [docs/cli-reference.md](../../docs/cli-reference.md).
