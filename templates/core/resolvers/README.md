...
| **`DOCKPIPE_RESOLVER_WORKFLOW`** | no | Bundled delegate YAML under **`templates/core/resolvers/<name>/config.yml`** (or legacy workflows path). **Mutually exclusive** with **`DOCKPIPE_RESOLVER_HOST_ISOLATE`**. |
