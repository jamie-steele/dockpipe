...
See **`make demo-record`**, **[docs/workflow-yaml.md](../../docs/workflow-yaml.md)**, **[docs/cli-reference.md](../../docs/cli-reference.md)** (env / `--var`). For DAG-style orchestration (parallel levels, pgvector, escalation) see **[docs/dorkpipe.md](../../docs/dorkpipe.md)** and **`shipyard/workflows/dorkpipe-orchestrator/`**.
