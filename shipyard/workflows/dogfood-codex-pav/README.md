...
This workflow ships with the dockpipe **source tree** under **`shipyard/workflows/`**. To reuse it elsewhere, copy the directory or run **`dockpipe init yourflow --from /path/to/shipyard/workflows/dogfood-codex-pav`**. See **[AGENTS.md](../../AGENTS.md)**.
